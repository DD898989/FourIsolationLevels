...
public static class DirtyReadEndpoint
{
    ...
    {
        app.MapGet("/api/dirty-read", (DemoIsolationLevel isolationLevel, IDbContextFactory<AppDbContext> dbFactory) =>
        {
        ...
        .WithDescription("**[點擊此處下載原始碼](/api/download/2_DirtyReadEndpoint.cs)**");
    }
}
