...
public static class WriteSkewEndpoint
{
    ...
    {
        app.MapGet("/api/write-skew", (DemoIsolationLevel isolationLevel, IDbContextFactory<AppDbContext> dbFactory) =>
        {
        ...
        .WithDescription("**[點擊此處下載原始碼](/api/download/1_WriteSkewEndpoint.cs)**");
    }
}
